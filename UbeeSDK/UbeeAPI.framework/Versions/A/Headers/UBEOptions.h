...
@property (nonatomic, strong) NSString *adsDevelopmentKey;
@property (nonatomic, strong) NSString *adsDevelopmentSecret;
...
- (void)setAdsDevelopmentKey:(NSString *)adsDevelopmentKey andSecret:(NSString *)adsDevelopmentSecret;
