...
#define ILM_CONSENT_TYPE_INSTALLED_APPS     @"installed_apps"
#define ILM_CONSENT_TYPE_LOCATION           @"location"
#define ILM_CONSENT_TYPE_CONTEXT_PROVIDER   @"context_provider"

// Consent sets
#define ILM_CONSENT_SET_ALL                 [NSSet setWithArray:@[ILM_CONSENT_TYPE_ADDRESS_VALIDATION, ILM_CONSENT_TYPE_ADVERTISEMENT, ILM_CONSENT_TYPE_EVENTS, ILM_CONSENT_TYPE_INSTALLED_APPS, ILM_CONSENT_TYPE_LOCATION, ILM_CONSENT_TYPE_CONTEXT_PROVIDER]]
